...
const Support = () => {
  ...
  const handleCreateTicket = async (e) => {
    ...
    try {
      const response = await axios.post('https://us-central1-cinemate-4d8fe.cloudfunctions.net/api/supportTicket', {
        email,
        subject,
        message,
        issueType
  ...
  const handleFetchTickets = async () => {
    ...
    try {
      const response = await axios.get(`https://us-central1-cinemate-4d8fe.cloudfunctions.net/api/supportTicket/${ticketId}`);
  ...
  const handleReply = async () => {
    ...
    try {
      ...
      await axios.post(`https://us-central1-cinemate-4d8fe.cloudfunctions.net/api/supportTicket/${currentTicket.uniqueIdentifier}/respond`, { reply, isAdmin, uid: user.uid });

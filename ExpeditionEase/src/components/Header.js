...
const Header = () => {
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="lg">
      <Container>
        <Navbar.Brand>Travel Itinerary Planner</Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            {user && (
              <>
                <Nav.Link as={Link} to="/itinerarys">Itinerarys</Nav.Link>
                <Nav.Link as={Link} to="/add-itinerary">Add Itinerary</Nav.Link>
